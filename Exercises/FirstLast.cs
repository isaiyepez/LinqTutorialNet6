...
namespace Exercises
{
    public static class FirstLast
    {
        ...
        {
            return words.FirstOrDefault(word => word.Length > 1 && char.IsUpper(word.First()) && word.Count(character => char.IsUpper(character)) == 1);
        }
        ...
        {
            //TODO your code goes here
            return people.FirstOrDefault(person => person.Pets.Any(p => p == pet));
        }
