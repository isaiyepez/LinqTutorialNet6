...
namespace Exercises
{
    public static class Count
    {
        ...
        public static bool IsAnySequenceTooLong_Refactored(IEnumerable<IEnumerable<int>> numberSequences, int maxLength)
        {
            ...
            return numberSequences.Any(numberSeq => numberSeq.Count() > maxLength);
        }
